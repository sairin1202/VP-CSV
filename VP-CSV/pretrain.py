...
def get_dataloader():
    ...
    video_len = 5
    n_channels = 3
    storydataset = PretrainDataset(data_dir, video_transforms)
...
if __name__ == "__main__":
    ...
    optimizer, scheduler = get_optimizer(model=dalle, lr=0.0004, train_steps=epoch*len(data), warmup_steps=0.05*epoch*len(data))
